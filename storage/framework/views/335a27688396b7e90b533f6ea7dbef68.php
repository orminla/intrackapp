            ...
            >
                <div class="input-group align-items-center" style="gap: 4px">
                    ...
                    <input
                        ...
                        placeholder="<?php echo e($currentRoute === "inspector.dashboard" ? "Pencarian dinonaktifkan di dashboard" : "Ketik & tekan Enter untuk mencari"); ?>"
                        style="padding-left: 0.3rem"
                        value="<?php echo e(request("search")); ?>"
                        <?php echo e($currentRoute === "inspector.dashboard" ? "readonly" : ""); ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (
            searchInput &&
            form &&
            '<?php echo e($currentRoute); ?>' !== 'inspector.dashboard'
        ) {
            // Auto Search (AJAX)
