...
>
    <div>
        ...
        >
            ...
            >
                <img
                    src="<?php echo e(asset("admin_assets/images/logo_intrackapp.png")); ?>"
                    alt="InTrack App"
                    style="max-width: 90%"
                />
            </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item mb-2">
                    <a
                        class="sidebar-link justify-content-between"
                        href="<?php echo e(route("admin.jadwal.index")); ?>"
                    >
                        <div class="d-flex align-items-center gap-3">
                ...
                <li class="sidebar-item mb-2">
                    <a
                        class="sidebar-link justify-content-between"
                        href="<?php echo e(route("admin.petugas.index")); ?>"
                    >
                        <div class="d-flex align-items-center gap-3">
...
<!-- Sidebar End -->
<?php /**PATH E:\laragon\www\ta_intrackapp\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>