        ...
        <div class="modal-content rounded-4 p-4">
            ...
            <div class="modal-body">
                ...
                <div class="field-row d-flex">
                    ...
                    <div>: <?php echo e($profile["nip"] ?? "-"); ?></div>
                </div>
                <div class="field-row d-flex">
                    <div class="field-label">Jenis Kelamin</div>
                    <div>: <?php echo e($profile["gender"] ?? "-"); ?></div>
                </div>
                <div class="field-row d-flex">
                ...
                <div class="field-row d-flex">
                    ...
                    <div>: <?php echo e($profile["phone_num"] ?? "-"); ?></div>
                </div>
                <div class="field-row d-flex">
                    <div class="field-label">Bidang</div>
                    <div>: <?php echo e($profile["department"] ?? "-"); ?></div>
                </div>
                <div class="field-row d-flex">
                    <div class="field-label">Portofolio</div>
                    <div>: <?php echo e($profile["portfolio"] ?? "-"); ?></div>
                </div>
                ...
                <div class="field-row certification-section">
                    ...
                    >
                        <?php if(isset($profile["certifications"]) && $profile["certifications"]->isNotEmpty()): ?>
                            <?php $__currentLoopData = $profile["certifications"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                >
                                    ...
                                    <div class="small text-muted">
                                        Diterbitkan oleh
                                        <?php echo e($cert->issuer ?? "-"); ?> & berlaku
                                        sejak
