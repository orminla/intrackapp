...
export default class Theme {
    ...
    checkHeatmapDistributed() {
        ...
        return (
            (chart.type === 'treemap' && plotOptions.treemap && plotOptions.treemap.distributed) ||
            (chart.type === 'heatmap' && plotOptions.heatmap && plotOptions.heatmap.distributed)
        );
    }
    ...
    applyMarkersColors(defaultColors) {
        ...
        w.globals.markers.colors =
            w.config.markers.colors === undefined ? defaultColors : w.config.markers.colors.slice();
