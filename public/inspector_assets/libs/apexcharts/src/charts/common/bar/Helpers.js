...
export default class Helpers {
    ...
    initialPositions() {
        ...
        if (this.barCtx.isHorizontal) {
            ...
            barWidth =
                ((xDivision / seriesLen) * parseInt(this.barCtx.barOptions.columnWidth, 10)) / 100;
            ...
            if (w.globals.isXNumeric) {
                ...
                barWidth =
                    ((xDivision / seriesLen) * parseInt(this.barCtx.barOptions.columnWidth, 10)) /
                    100;
    ...
    getYForValue(value, zeroH, translationsIndex, zeroPositionForNull = true) {
        ...
        if (typeof value !== 'undefined' && value !== null) {
            yForVal =
                ...
                (this.barCtx.isReversed ? value / this.barCtx.yRatio[translationsIndex] : 0) * 2;
        }
        return yForVal;
    }
