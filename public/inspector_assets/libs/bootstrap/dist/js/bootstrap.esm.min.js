...
const getSelector = (e) => {
    ...
    enableDismissTrigger = (e, t = 'hide') => {
        ...
        EventHandler.on(document, n, `[data-bs-dismiss="${i}"]`, function (n) {
            if ((['A', 'AREA'].includes(this.tagName) && n.preventDefault(), isDisabled(this)))
                return;
...
class Dropdown extends BaseComponent {
    ...
    _selectMenuItem({ key: e, target: t }) {
        const n = SelectorEngine.find(SELECTOR_VISIBLE_ITEMS, this._menu).filter((e) =>
            isVisible(e),
        );
...
class Tooltip extends BaseComponent {
    ...
    show() {
        ...
        const e = EventHandler.trigger(this._element, this.constructor.eventName('show')),
            t = (
                findShadowRoot(this._element) || this._element.ownerDocument.documentElement
...
class ScrollSpy extends BaseComponent {
    ...
    _activateParents(e) {
        if (e.classList.contains('dropdown-item'))
            SelectorEngine.findOne('.dropdown-toggle', e.closest('.dropdown')).classList.add(
                'active',
            );
        else
