...
(function (global, factory) {
    ...
    var nativeWeakMap =
        typeof WeakMap$1 === 'function' && /native code/.test(functionToString.call(WeakMap$1));
	...
	*/
    ...
    var hex = /^[+-]?0[Xx]/;
    var FORCED =
        nativeParseInt(whitespaces + '08') !== 8 || nativeParseInt(whitespaces + '0x16') !== 22;
    ...
    var isElement = function (obj) {
        ...
        var scope =
            (_b = (_a = obj) === null || _a === void 0 ? void 0 : _a.ownerDocument) === null ||
            _b === void 0
                ? void 0
                : _b.defaultView;
        ...
        (function () {
            ...
            SimpleBar.getOffset = function getOffset(el) {
                ...
                return {
                    ...
                    left:
                        rect.left + (elWindow.pageXOffset || elDocument.documentElement.scrollLeft),
                };
            };
