...
export default class Dimensions {
    ...
    plotCoords() {
        ...
        gl.translateX =
            gl.translateX + this.gridPad.left + this.xPadLeft + (barWidth > 0 ? barWidth : 0);
    ...
    setDimensionsForAxisCharts() {
        ...
        switch (w.config.legend.position) {
            ...
            case 'left':
                ...
                gl.gridWidth =
                    gl.svgWidth - this.lgRect.width - yAxisWidth - this.datalabelsCoords.width * 2;
                break;
            case 'right':
                gl.translateY = translateY;
                gl.translateX = yAxisWidth + this.datalabelsCoords.width;
    ...
    conditionalChecksForAxisCoords(xaxisLabelCoords, xtitleCoords, xaxisGroupLabelCoords) {
        ...
        const baseXAxisHeight =
            xaxisGroupLabelCoords.height + xaxisLabelCoords.height + xtitleCoords.height;
