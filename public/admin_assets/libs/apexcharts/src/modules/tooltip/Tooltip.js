...
export default class Tooltip {
    ...
    axisChartsTooltips({ e, opt }) {
        ...
        if (e.type === 'mousemove' || e.type === 'touchmove' || e.type === 'mouseup') {
            ...
            if (
                w.globals.collapsedSeries.length + w.globals.ancillaryCollapsedSeries.length ===
    ...
    markerClick(e, seriesIndex, dataPointIndex) {
        ...
        this.ctx.events.fireEvent('markerClick', [e, this.ctx, { seriesIndex, dataPointIndex, w }]);
    }
    ...
    create(e, context, capturedSeries, j, ttItems, shared = null) {
        ...
        const commonSeriesTextsParams = {
            ...
            i: capturedSeries,
            j,
            ...(typeof w.globals.seriesRange?.[capturedSeries]?.[j]?.y[0]?.y1 !== 'undefined' && {
                y1: w.globals.seriesRange?.[capturedSeries]?.[j]?.y[0]?.y1,
            }),
            ...(typeof w.globals.seriesRange?.[capturedSeries]?.[j]?.y[0]?.y2 !== 'undefined' && {
