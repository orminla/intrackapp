...
!(function (e, t) {
    ...
    ((Te.tbody = Te.tfoot = Te.colgroup = Te.caption = Te.thead),
        (Te.th = Te.td),
        le.option || (Te.optgroup = Te.option = [1, "<select multiple='multiple'>", '</select>']));
    var Se = /<|&#?\w+;/;
        ...
        special: {
            ...
            click: {
                ...
                _default: function (e) {
                    var t = e.target;
                    return (
                        (xe.test(t.type) && t.click && fe(t, 'input') && _.get(t, 'click')) ||
                        fe(t, 'a')
                    );
                },
            },
        ...
        trigger: function (e, t, n, r) {
            ...
            if (
                ...
                3 !== n.nodeType &&
                    ...
                    ((e = e[ce.expando]
                        ? e
                        : new ce.Event(p, 'object' == typeof e && e)).isTrigger = r ? 2 : 3),
                    (e.namespace = h.join('.')),
    ...
    function Ct(n, e, r, i) {
        ...
        if (Array.isArray(e))
            ce.each(e, function (e, t) {
                r || mt.test(n)
                    ? i(n, t)
                    : Ct(n + '[' + ('object' == typeof t && null != t ? e : '') + ']', t, r, i);
            });
        ...
        (ce.parseHTML = function (e, t, n) {
            return 'string' != typeof e
                ...
                : ('boolean' == typeof t && ((n = t), (t = !1)),
                  t ||
                      (le.createHTMLDocument
                          ? (((r = (t = m.implementation.createHTMLDocument('')).createElement(
                                'base',
