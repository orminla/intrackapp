...
<header class="app-header bg-white shadow-sm">
    <nav class="navbar navbar-expand-lg navbar-light">
            ...
            >
                <div class="input-group align-items-center" style="gap: 4px">
                    ...
                    <input
                        ...
                        placeholder="{{ $currentRoute === "admin.dashboard" ? "Pencarian dinonaktifkan di dashboard" : "Ketik & tekan Enter untuk mencari" }}"
                        style="padding-left: 0.3rem"
                        value="{{ request("search") }}"
                        {{ $currentRoute === "admin.dashboard" ? "readonly" : "" }}
                    />
        ...
        >
            <img
                src="{{ $profile["photo_url"] ?? asset("admin_assets/images/profile/user-7.jpg") }}"
                alt="Profile"
                width="40"
                height="40"
